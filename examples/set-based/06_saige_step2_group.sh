...
MAX_MAF=0.001,0.05,0.1       # Maximum MAF for variants to include
...
rm -f ${OUTPUT_DIR}/saige.step2.additive.group.txt.index
rm -f ${OUTPUT_DIR}/saige.step2.additive.group.txt.singleAssoc.txt
rm -f ${OUTPUT_DIR}/saige.step2.additive.group.txt.singleAssoc.txt_temp
echo "  Removed temporary and singleAssoc files"
echo ""
