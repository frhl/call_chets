...
LEGACY_LINKS := bin/arcade bin/call_chets bin/encode_vcf bin/transform bin/filter_vcf_by_pp bin/orthogonalize
...
legacy_links: $(TARGETS)
	@ln -sf interpret_phase bin/arcade
...
install: all
	...
	@ln -sf interpret_phase $(PREFIX)/bin/arcade
